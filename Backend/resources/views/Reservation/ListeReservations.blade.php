                ...
                <table class="min-w-full border border-gray-200 rounded-xl shadow-md text-gray-700" id="reservationTable">
                    <thead class="bg-gray-100">
                        <tr class="text-left border-b">
                            ...
                            <th class="p-3">date_debut</th>
                            <th class="p-3">date_fin</th>
                    ...
                    <tbody>
                       @foreach ($reserv as $item)
                           <tr>
                            ...
                            <td class="p-3">{{ $item->client->nom }} &nbsp;{{ $item->client->prenom }}</td>                   
                            <td class="p-3">{{ $item->voiture->title }}</td>                   
                            <td class="p-3">{{$item->date_debut}}</td>
                            <td class="p-3">{{$item->date_fin}}</td>
                            <td class="p-3">{{$item->statut}}</td>
