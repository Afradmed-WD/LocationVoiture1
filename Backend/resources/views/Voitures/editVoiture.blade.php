...
<body class="bg-gray-100">
    <div class="flex ">
        ...
        <div class="">
                ...
                <div class="mx-10 flex items-center space-x-2">
                    ...
                    <div class="">
                        <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M24.2212 2.7878C24.5263 3.06849 24.5263 3.52358 24.2212 3.80427L22.5917 5.30341L19.4667 2.42841L21.0962 0.929267C21.4013 0.648578 21.896 0.648578 22.2011 0.929267L24.2212 2.7878Z" fill="#F29036"/>
                            <path d="M21.4869 6.31988L18.3619 3.44488L7.71658 13.2386C7.63082 13.3175 7.5662 13.4136 7.52785 13.5195L6.27072 16.9892C6.16893 17.2701 6.45945 17.5374 6.76483 17.4437L10.5362 16.2872C10.6513 16.2519 10.7558 16.1925 10.8416 16.1136L21.4869 6.31988Z" fill="#F29036"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1.5625 19.4062C1.5625 20.5971 2.61183 21.5625 3.90625 21.5625H21.0938C22.3882 21.5625 23.4375 20.5971 23.4375 19.4062V10.7812C23.4375 10.3843 23.0877 10.0625 22.6562 10.0625C22.2248 10.0625 21.875 10.3843 21.875 10.7812V19.4062C21.875 19.8032 21.5252 20.125 21.0938 20.125H3.90625C3.47478 20.125 3.125 19.8032 3.125 19.4062V3.59375C3.125 3.1968 3.47478 2.875 3.90625 2.875H14.0625C14.494 2.875 14.8438 2.5532 14.8438 2.15625C14.8438 1.7593 14.494 1.4375 14.0625 1.4375H3.90625C2.61183 1.4375 1.5625 2.40289 1.5625 3.59375V19.4062Z" fill="#F29036"/>
                            </svg>
            ...
            <form action="{{ route('update',$data1->id) }}" method="POST" class="border border-gray-300 bg-white rounded-xl space-y-6 my-8">
                @csrf
                @method('PUT')
                {{-- <p class="text-center text-2xl font-bold">Modifier Une Voiture</p> --}}
                <div class="mx-10 flex-col justify-center">
                   <div class="">
                    
                    <label for="">ImageP:
                        <br>
                        <input type="text" name="ImageP" value="{{old('ImageP',$data1->ImageP)}}"  placeholder="Donner URL de L'image Pricipale" class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700">
                    </label>
                </div><br>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="">
                        <label for="">ImageS1:
                            <br>
                            <input type="text" name="ImageS1" value="{{old('ImageS1',$data1->ImageS1)}}" placeholder="donner URL de L'image secondaire 1 " class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                        </label>
                    </div>
                    <div class="">
                        <label for="">ImageS2:
                            <br>
                            <input type="text" name="ImageS2" value="{{old('ImageS2',$data1->ImageS2)}}" placeholder="Donner URL de L'image secondaire 2 " class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                        </label>
                    </div>
                    <div class="">
                        <label for="">ImageS3:
                            <br>
                            <input type="text" name="ImageS3" value="{{old('ImageS3',$data1->ImageS3)}}" placeholder="Donner URL de L'image secondaire 3 " class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                        </label>
                    </div>
                </div>    
                <br>
                    <div class="grid grid-cols-4 gap-2">
                        <div class="">
                            <label for="">Title:
                                <br>
                                <input type="text" value="{{old('title',$data1->title)}}" name="title" placeholder="donner le titre de ce Voiture" class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                            </label>
                        ...
                        <div class="">
                            <label for="">Type:
                                <br>
                                <input type="text" value="{{old('type',$data1->type)}}" name="type" placeholder="donner le type de Voiture" class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                            </label>
                        </div>
                        <div class="">
                            <label for="">Prix_Jour:
                                <br>
                                <input type="text" value="{{old('prix_jour',$data1->prix_jour)}}" name="prix_jour" placeholder="donner la Prix Par Jour" class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                            </label>
                        </div>
                       <div class="">
                        <label for="">Status:
                            ...
                            <select name="status" id="status" class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700">
                                <option disabled selected>Choisissez la Disponibilité</option>
                            
                                <option value="disponible" {{ old('status', $data1->status) == 'disponible' ? 'selected' : '' }}>Disponible</option>
                                <option value="réservée" {{ old('status', $data1->status) == 'réservée' ? 'selected' : '' }}>réservée</option>
                            </select>
                   ...
                   <div class="grid grid-cols-3 gap-4">
                    <div class="">
                        <label for="">Consomation:
                            <br>
                            <input type="text"  value="{{old('consomation',$data1->consomation)}}" name="consomation" placeholder="donner le consommation de voiture" class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                        </label>
                    ...
                    <div class="">
                        <label for="">Category:
                            <br>
                            <input type="text" value="{{old('category',$data1->category)}}" name="category" placeholder="donnerle categroy ce ce Voiture" class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                        </label>
                    </div>
                    <div class="">
                        <label for="">Dor:
                            <br>
                            <input type="text" value="{{old('dor',$data1->dor)}}" name="dor" placeholder="Combien de Passengers dans ce Voiture" class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700"">
                        </label>
                    </div>
                   </div>
                   <div class="">
                    <label for="">description:
                        <br>
                        <textarea name="description" placeholder="Donner une description pour cette voiture"
                        class="border border-gray-700 rounded-xl p-2 w-full mx-20 focus:ring-2 focus:outline-none focus:ring-blue-700">
                        {{ old('description', $data1->description) }}
                    </textarea>
                                        </label>
                   </div>
                   <center>
                    <div class="flex justify-center my-3 bg-gradient-to-l from-blue-500 to-purple-500 max-w-sm rounded-xl items-center">
                        <button type="submit" class="p-2 px-4 bg-gradient-to-l from-blue-300 to-purple-300 text-white font-semibold font-serif">Modifier</button>
                       </div>
                   </center>
