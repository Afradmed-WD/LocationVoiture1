    ...
    return (
        ...
        <div className="">
            ...
            <div className="bg-gray-100 w-full min-h-screen">
                <div className="grid grid-cols-2 mx-10 py-10 gap-10">
                    <div className="border rounded-xl bg-white">
                        <img src={donne.ImageS2} />
                        <div className="grid grid-cols-3">
                            <div className="rounded-xl flex">
                                <img src={donne.ImageS1} />
                            </div>

                            <div className="">
                                <img src={donne.ImageS3} />
                            </div>
                            <div className="">
                                <img src={donne.ImageP} />
                            </div>
                        </div>
                    </div>
                    <div className="bg-white border border-gray-50 rounded-xl w-full ">
                        <div className="font-bold font-serif text-2xl mx-10 my-5 block">
                            {donne.title}
                        </div>
                        ...
                        <div className="grid grid-cols-2 mx-10 mt-5">
                            <div className="">
                                <span className="text-gray-600">Tppe Car:</span>{" "}
                                {donne.category}
                            </div>
                            <div className="">
